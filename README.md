...
遊び方やライセンスなどの各種ドキュメントは、2つのFormulaのいずれでも共通のドキュメントディレクトリにインストールされます。Apple Silicon環境では、おおむね次の場所になります。
...
2つのFormulaはいずれも、標準では `jrogue.save`、`jrogue.scr`、`jrogue.lck` を共通で使います。
