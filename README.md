...
Homebrew版では、Formulaごとに実行ファイル名を変えてビルドされるため、標準のセーブファイル、スコアファイル、ロックファイルもそれぞれ別名になります。

| Formula | セーブファイル | スコアファイル | ロックファイル |
| ------- | -------------- | -------------- | -------------- |
| `jrogue` | `jrogue.save` | `jrogue.scr` | `jrogue.lck` |
| `jrogue-original` | `jrogue-original.save` | `jrogue-original.scr` | `jrogue-original.lck` |
| `jrogue-wizard` | `jrogue-wizard.save` | `jrogue-wizard.scr` | `jrogue-wizard.lck` |
