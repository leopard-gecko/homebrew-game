...
遊び方やライセンスなどの各種ドキュメントは、3つのFormulaのいずれでも共通のドキュメントディレクトリにインストールされます。Apple Silicon環境では、おおむね次の場所になります。
...
3つのFormulaはいずれも、標準では `jrogue.save`、`jrogue.scr`、`jrogue.lck` を共通で使います。これらは基本的にカレントディレクトリに作成されます。
